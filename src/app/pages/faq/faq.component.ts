  ...
  protected readonly faqs: FAQItem[] = [
    {
      ...
      answer:
        'Ja! Am Donnerstag, den 23.07., könnt ihr von 17:00 bis 22:00 Uhr mit dem Auto auf den Campingplatz fahren. Ab Freitag 10:00 Uhr ist die Anreise wie gewohnt möglich. Bitte denkt an Auto und Wohnmobil Pässe.',
      category: 'arrival',
    },
    {
      id: 'arrival-dropoff',
    ...
    },
    {
      ...
      answer:
        'Früher Camping-Zugang schon am Donnerstag (23.07.) von 17:00 bis 22:00 Uhr. Check-in ab Freitag 10:00 Uhr, Floors laufen bis Sonntag abend. Abreise bis Montag 12:00 Uhr.',
      category: 'general',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Nachhaltigkeit ist ein Prozess: Wir verbessern Schritt für Schritt. Auf dem Festivalgelände versuchen wir, hauptsächlich vegetarische Produkte anzubieten – auch das ist Teil unseres Nachhaltigkeitskonzepts. Aktuell gibt es Dixi-Toiletten auf dem Campingplatz, saubere Toiletten auf dem Gelände gegen Beitrag und kostenpflichtige Duschen per Flatrate, weil es keine feste Wasserinfrastruktur gibt. Für kommende Jahre arbeiten wir an besseren, nachhaltigeren Lösungen.',
      category: 'camping',
    },
  ];
